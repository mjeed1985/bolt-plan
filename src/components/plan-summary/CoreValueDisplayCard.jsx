...
=======
    <Card className="shadow-md hover:shadow-lg transition-shadow duration-300 bg-white">
        <CardHeader className="flex flex-row items-center space-x-3 pb-2 bg-sky-50/70 rounded-t-lg border-b border-sky-100">
            {IconComponent && <IconComponent className="w-6 h-6 text-sky-600" />}
            <CardTitle className="text-md font-semibold text-sky-700">{valueName}</CardTitle>
