...
=======
  <Card className={`shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white/90 backdrop-blur-sm border-gray-200/80 ${className}`}>
    <CardHeader className="flex flex-row items-center space-x-3 space-y-0 pb-3 bg-sky-50/70 rounded-t-lg border-b border-sky-200">
      {React.cloneElement(icon, { className: "h-6 w-6 text-sky-600" })}
      <CardTitle className="text-lg font-semibold text-sky-700">{title}</CardTitle>
